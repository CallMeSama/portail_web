...
<html lang="en">
  ...
  <body class="img js-fullheight" style="background-image: url(../assets/images/caméra.jpg);">
    <section class="ftco-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-6 text-center mb-5">
            <h2 class="heading-section">CinéGourmet ~ CONNEXION</h2>
          </div>
        </div>
        <div class="row justify-content-center">
          <div class="col-md-6 col-lg-4">
            <div class="login-wrap p-0">
              ...
              <div>
                <a href="#" class="px-2 py-2 mr-md-1 rounded"><span class="ion-logo-facebook mr-2"></span></a>
                <a href="#"><span class="ion-logo-twitter mr-2"></span></a>
              </div>
              <div>
                <a href="#" class="px-2 py-2 mr-md-1 rounded"><span class="ion-logo-facebook mr-2"></span></a>
                <a href="#"><span class="ion-logo-twitter mr-2"></span></a>
